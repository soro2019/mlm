<footer class="main-footer">
    ...
    <strong>Copyright &copy; 2018 SHAPPINVEST par <a href="http://jprobeweb.com">JPROBEWEB</a>.</strong> Tous droits réservés.
</footer>
...
<?php $i = 0; if(isset($js_files)){
    foreach($js_files as $file): 
        if($i==1)
        {  
?>
        <script src='<?php echo site_url('assets/membre/dist/js/jquery.cookie.js')?>'></script>
    <?php } ?>
     <script src="<?php echo $file; ?>"></script>

<?php $i++; endforeach; if(isset($addFooter)){ echo $addFooter; } } ?>
...
<script>
	...
	function generateUserTable(element){	
		jQuery.ajax({
			url: '<?= site_url('administrator~gie2018/principal/gestion_membres_data');?>',
...
<script>
	...
	function generateUserTable(element){	
		jQuery.ajax({
			url: '<?= site_url('administrator~gie2018/gestion_agences/etat_data');?>',
...
<script>
	...
	function generateUserTable(element){	
		jQuery.ajax({
			url: '<?= site_url('administrator~gie2018/gestion_agences/compte_agence_data');?>',
