...
$data['page_title'] = 'Gestion des langues du site | Administration';
$data['titre'] = 'Gestion des langues du site';
$data['lien'] = 'Gestion des langues';
$titre = 'Gestion des langues du site';
