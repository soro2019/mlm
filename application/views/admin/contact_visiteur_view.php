...
$data['page_title'] = 'Gestion des contacts visiteurs | Administration';
$data['titre'] = 'Gestion des contacts visiteurs';
$data['lien'] = 'Gestion des contacts visiteurs';
$titre = 'Gestion des contacts visiteurs';
