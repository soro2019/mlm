...
<div class="login-box">
  <div class="login-logo">
    <a href="<?php echo site_url('/');?>"><img src="<?php echo site_url('assets/membre/logo/logo-gie.png');?>" alt=""></a>
  </div>
  <!-- /.login-logo -->
  <div class="login-box-body">
    ...
    <a href="<?php echo site_url('mot-de-passe-oublie');?>">J'ai oublié mon mot de passe</a><br>
